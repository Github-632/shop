...
<div class="head">
    <div class="wrapper clearfix">
        ...
        <a href="index.html"><img src="img/logo.jpg"/></a></h1>
        ...
        <a href="manger/admin_index.jsp" id="login">进入后台管理</a>
                ...
                <form action="/shop/doproductselect" method="get">
 
                    <table class="search-tab">
                        <tr>
                            <td><input  placeholder="热门搜索：鹌鹑冻干" name="productwords" value="" id="" type="text"></td>
