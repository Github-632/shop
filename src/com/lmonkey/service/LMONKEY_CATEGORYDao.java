...
public class LMONKEY_CATEGORYDao {
	 public static ArrayList<LMONKEY_CATEGORY> selectAll() {//int cpage, int count
   	  ...
   	  Connection conn = Basedao.getconn();
   	   ...
   	   try { 
   	String sql = "select * from puppyshop_category ";
	...
	rs=ps.executeQuery();
	  ...
	  */
	  ...
	  public static int insert(LMONKEY_CATEGORY cate) {
    	  ...
    	  String sql = "insert into puppyshop_category values(?, ?, ?)"; 
    	  Object[] params= {
    			  cate.getCATE_ID(),
    			  cate.getCATE_NAME(),
	  ...
	  public static LMONKEY_CATEGORY selectById(int id) {
	    	 LMONKEY_CATEGORY cate = null;
	    	  ...
	    	  Connection conn = Basedao.getconn();
	    	   ...
	    	   try {
	        String sql = "select * from puppyshop_category where CATE_ID=?";
	        ps = conn.prepareStatement(sql);
	        ps.setInt(1, id);
	  ...
	  public static int update(LMONKEY_CATEGORY cate) {
    	  String sql = "update puppyshop_category set CATE_NAME=?, CATE_PARENT_ID=? where CATE_ID = ? "; 
    	  Object[] params= {
    			  cate.getCATE_NAME(),
    			  cate.getCATE_PARENT_ID(),
    			  cate.getCATE_ID()
	  ...
	  public static int del(int id) {
		  String sql = "delete from puppyshop_category where CATE_ID=?";
		  Object[] params = {id};
		 return  Basedao.exectuIUD(sql, params);
	  }  
			 ...
			 public static ArrayList<LMONKEY_CATEGORY> selectCat(String flag) {
		   	...
		   	try {
				...
				if(flag!=null && flag.equals("father")){
					...
					sql = "select * from puppyshop_category where CATE_PARENT_ID=0";
				}else{
					sql = "select * from puppyshop_category where CATE_PARENT_ID!=0";
				}
				ps = conn.prepareStatement(sql);
