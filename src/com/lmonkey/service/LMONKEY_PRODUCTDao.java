...
public class LMONKEY_PRODUCTDao {
	 public static int insert(LMONKEY_PRODUCT p) {
   	  ...
   	  String sql = "insert into puppyshop_product values(?, ?, ?, ?, ?, ?, ?, ?)"; 
   	  Object[] params= {
   			  p.getPRODUCT_ID(),
   			  p.getPRODUCT_NAME(),
	 ...
	 public static ArrayList<LMONKEY_PRODUCT> selectAll() {
	   	  ...
	   	  Connection conn = Basedao.getconn();
	   	   ...
	   	   try { 
	   	String sql = "select * from puppyshop_product ";
	 ...
	 public static ArrayList<LMONKEY_PRODUCT> selectByAllFid(int fid) {
	   	  ...
	   	  Connection conn = Basedao.getconn();
	   	   ...
	   	   try { 
	   	String sql = "select * from puppyshop_product where PRODUCT_FID=?";
	   	ps = conn.prepareStatement(sql);
	 ...
	 public static ArrayList<LMONKEY_PRODUCT> selectByAllCid(int cid) {
	   	  ...
	   	  Connection conn = Basedao.getconn();
	   	   ...
	   	   try { 
	   	String sql = "select * from puppyshop_product where PRODUCT_CID=?";
	   	ps = conn.prepareStatement(sql);
	 ...
	 public static LMONKEY_PRODUCT selectById(int id) {
	   	 LMONKEY_PRODUCT p = null;
	   	  ...
	   	  Connection conn = Basedao.getconn();
	   	   ...
	   	   try { 
	   	String sql = "select * from puppyshop_product where PRODUCT_ID=?";
	   	ps = conn.prepareStatement(sql);
		ps.setInt(1, id);
		rs=ps.executeQuery();
	 ...
	 public static int del(int id) {
   	  String sql = "delete from puppyshop_product where PRODUCT_ID=?";
   	 Object[] params = {id};
   	  return Basedao.exectuIUD(sql, params);
     } 
     ...
     public static ArrayList<LMONKEY_PRODUCT> selectAll1(String keyword) {
   	  ArrayList<LMONKEY_PRODUCT> list=new ArrayList<LMONKEY_PRODUCT>();
   	  ResultSet rs = null;//声明结果集
   	  //获取连接对象
   	  Connection conn = Basedao.getconn();
       ...
       String sql = "";
       if(keyword!=null) {
       	sql="select * from puppyshop_product where PRODUCT_NAME like ? ";//'%"+keyword+"%'
       }else {
   		   
   	 sql = "select * from puppyshop_product ";
       } 
